...
const Sidebar = () => {
  return (
    <div>
      <aside className="flex flex-col w-64 px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 h-full min-h-screen">
        <div className="flex flex-col justify-between flex-1 mt-6">
          <nav className="flex-1 -mx-3 space-y-3 ">
            ...
            >
              ...
              <span className="mx-2 text-sm font-medium">Salas disponibles</span>
            </a>
            ...
            >
              ...
              <span className="mx-2 text-sm font-medium">Software disponible</span>
            </a>
            ...
            >
              ...
              <span className="mx-2 text-sm font-medium">Generar reserva</span>
            </a>
          </nav>
          ...
          <div className="mt-6">
            <div className="p-3 bg-gray-100 rounded-lg dark:bg-gray-800">
              ...
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                Los festivos no se abre debido a que ya que entonces se celebra el día
                mundial de y es festivo si.
              </p>
